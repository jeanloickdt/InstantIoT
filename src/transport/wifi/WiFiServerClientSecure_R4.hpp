...
/**
 * ============================================================
 * 🔐 WiFiServerClientSecure_R4.hpp — TLS transport (Arduino Uno R4 WiFi)
 * ============================================================
 *
...
#  error "WiFiServerClientSecure_R4.hpp requires Arduino Uno R4 WiFi"
#endif
...
class WiFiServerClientSecure_R4 : public ITransport {
public:

    WiFiServerClientSecure_R4(
