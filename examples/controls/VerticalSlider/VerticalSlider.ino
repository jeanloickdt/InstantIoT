 ...
 *
 * In the app: a vertical slider on I0, bounded 0 to 100.
 *
...
IVerticalSlider(I0, float value) {
...
void setup() {
    ...
    InstantIoT.begin(AccessPoint("InstantIoT_VSlider", "12345678"));
}
